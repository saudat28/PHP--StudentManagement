...
<div class="row">
            <div class="col">
              <h2>CONFIRM GRADUAND</h2>
            <div class="add-form">
                        <form action="../../classes/graduate.class.php" method="post">
                        <div class="mb-3">
                        <?php 
      ...
      <div class="mb-3">
          <a class="button1" href="../../classes/graduate.class.php?graduateid=<?php echo  $Student1['student_id'];?>"> OK </a></button>
